...
def login():
	...
	if request.method == 'POST' and 'username' in request.form and 'password' in request.form:
		...
		cursor= mysql.connection.cursor("CREATE TABLE logintable if not exist(id INT NOT NULL AUTO_INCREMENT,username VARCHAR(50) NOT NULL,password VARCHAR(100) NOT NULL,email VARCHAR(50),PRIMARY KEY(id)")
